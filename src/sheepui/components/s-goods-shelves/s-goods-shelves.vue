    ...
    >
      ...
      >
        <s-goods-column
          class="goods-card"
          size="xs"
          :goods-fields="data.fields"
          :tag-style="data.badge"
          :data="item"
          :title-color="data.fields.name?.color"
          :top-radius="data.borderRadiusTop"
          :bottom-radius="data.borderRadiusBottom"
          :title-width="(454 - marginRight * 2 - data.space * 2 - marginLeft * 2) / 2"
        ...
        <view class="goods-box ss-flex">
          ...
          >
            <s-goods-column
              ...
              :data="item"
              :title-color="data.fields.name?.color"
              :title-width="(750 - marginRight * 2 - data.space * 4 - marginLeft * 2) / 3"
              @click="sheep.$router.go('/pages/goods/index', { id: item.id })"
            />
          </view>
        </view>
