...
var Dayjs = /*#__PURE__*/ (function () {
  ...
  _proto.diff = function diff(input, units, _float) {
    ...
    result =
      ...
      (_C$Y$C$M$C$Q$C$W$C$D$[C.Y] = result / 12),
      (_C$Y$C$M$C$Q$C$W$C$D$[C.M] = result),
      (_C$Y$C$M$C$Q$C$W$C$D$[C.Q] = result / 3),
      (_C$Y$C$M$C$Q$C$W$C$D$[C.W] = (diff - zoneDelta) / C.MILLISECONDS_A_WEEK),
      (_C$Y$C$M$C$Q$C$W$C$D$[C.D] = (diff - zoneDelta) / C.MILLISECONDS_A_DAY),
      (_C$Y$C$M$C$Q$C$W$C$D$[C.H] = diff / C.MILLISECONDS_A_HOUR),
      (_C$Y$C$M$C$Q$C$W$C$D$[C.MIN] = diff / C.MILLISECONDS_A_MINUTE),
      (_C$Y$C$M$C$Q$C$W$C$D$[C.S] = diff / C.MILLISECONDS_A_SECOND),
