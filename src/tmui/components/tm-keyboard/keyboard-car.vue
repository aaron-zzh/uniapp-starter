  ...
  >
    ...
    <view class="flex flex-row">
      <view class="flex-9 flex flex-col">
        <view v-for="(item2, index2) in numberArray" :key="index2" class="flex-row flex flex-1">
          <tmSheet
          ...
          >
            <view style="width: 40rpx" class="flex flex-center flex-row">
              <tmText :user-interaction-enabled="false" :font-size="32" _class="text-weight-b" :label="item"></tmText>
            </view>
          </tmSheet>
        </view>
      </view>
      <view class="flex-1 flex flex-col">
        <tmSheet
          ...
          @click="keydown('学')"
        >
          <tmText :user-interaction-enabled="false" :font-size="32" _class="text-weight-b" label="学"></tmText>
        </tmSheet>
        <tmSheet
          hover-class="opacity-5 keywordBoradAni"
          no-level
