<template>
  ...
  >
    <view class="flex-center flex-row" style="height: 62rpx">
      <tm-text v-if="!_value && !props.showInputContent" :font-size="28" _class="text-weight-b" :label="props.title">
      </tm-text>
      <tm-text v-if="_value && props.showInputContent" :font-size="34" _class="text-weight-b pr-24" :label="_value">
      </tm-text>
    </view>
    <view>
        ...
        <tm-col :col="6" :height="0" :transprent="true">
          <tm-row :column="3">
            <tm-col
              ...
              @click="keydown(item)"
            >
              <tmText :user-interaction-enabled="false" :font-size="38" _class="text-weight-b" :label="item"></tmText>
            </tm-col>
            <tm-col
              hover-class="opacity-5 "
              :margin="[8, 0, 4, 0]"
              ...
              @click="keydown('0')"
            >
              <tmText :user-interaction-enabled="false" :font-size="38" _class="text-weight-b" label="0"></tmText>
            </tm-col>
            <tm-col
              hover-class="opacity-5 "
              :margin="[8, 0, 4, 0]"
              ...
              @click="keydown('.')"
            >
              <tmText :user-interaction-enabled="false" :font-size="38" _class="text-weight-b" label="."></tmText>
            </tm-col>
          </tm-row>
        </tm-col>
        <tm-col :col="1" :height="420" align="start" :transprent="true" :margin="[0]">
          <tm-row :column="1">
            <tm-col
              ...
              @click="del"
            >
              <tm-icon :user-interaction-enabled="false" name="tmicon-caret-left"></tm-icon>
            </tm-col>
            <tm-col
              hover-class="opacity-5 "
              :color="props.color"
              ...
              @click="confirm"
            >
              <tm-icon :user-interaction-enabled="false" name="tmicon-check"></tm-icon>
            </tm-col>
          </tm-row>
        </tm-col>
      </tm-row>
