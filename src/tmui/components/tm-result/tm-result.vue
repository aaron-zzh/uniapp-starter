<template>
  <view class="flex flex-col flex-col-center-center pa-32" @click="onClick">
    <tm-translate :event-penetration-enabled="true" name="zoom" :delay="300">
      <tm-sheet
        :dark="props.dark"
        :follow-theme="false"
    ...
    <view :event-penetration-enabled="true" class="flex flex-col flex-center pb-10">
      <tm-text
        :dark="props.dark"
        :follow-dark="props.followDark"
    ...
    <view :event-penetration-enabled="true" class="flex flex-col flex-center pb-24">
      <tm-text
        :dark="props.dark"
        :follow-dark="props.followDark"
        _class="opacity-6 "
