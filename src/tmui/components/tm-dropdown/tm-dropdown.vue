<template>
  <view class="flex flex-row relative">
    ...
    >
      <view class="relative zIndex-1 flex flex-row" @click.stop="openDromenu">
        <view ref="popver" :event-penetration-enabled="false" :user-interaction-enabled="false" class="flex flex-row"
          ><slot></slot
        ></view>
      </view>
      <view
      ...
      >
        <tm-translate ref="aniDom" reverse :name="tarnslateName" :duration="180" :auto-play="!isNvue">
          <view
            class="flex flex-col"
            :class="[
                ...
                <view class="flex-row flex pb-12 flex-row-center-between">
                  <view class="flex flex-row flex-row-center-start flex-1">
                    <tm-icon
                      ...
                      :name="item.icon"
                    ></tm-icon>
                    <tm-text :font-size="32" :label="item.text"></tm-text>
                  </view>
                  <tm-icon v-if="props.haveArrow" :font-size="22" _class="pl-24" name="tmicon-angle-right"></tm-icon>
                </view>
              </view>
