      ...
      >
        <slot>
          <tm-sheet
            ...
            :round="4"
          >
            <tm-text _class="text-size-xxs" :font-size="22" :label="props.percent + props.percentSuffix"> </tm-text>
          </tm-sheet>
        </slot>
      </view>
    </view>
...
const _bgColor = computed(
  () =>
    computedTheme({ ...props, color: props.bgColor, followTheme: false, linear: '' }, isDark.value, tmcfg.value)
      .backgroundColor
)
