<template>
  <view class="flex flex-col">
    ...
    >
      ...
      >
        <tm-icon v-if="status == 'loading'" :color="props.color" :font-size="24" spin name="tmicon-shuaxin"></tm-icon>
        <view v-if="status == 'error'" class="flex flex-row flex-center" @click="reset('pullTop')">
          <tm-icon
      ...
      >
        <tm-icon v-if="status == 'loading'" :color="props.color" :font-size="24" spin name="tmicon-shuaxin"></tm-icon>
        <view v-if="status == 'error'" class="flex flex-row flex-center" @click="reset('pullEnd')">
          <tm-icon
            :user-interaction-enabled="false"
            color="red"
            :font-size="24"
