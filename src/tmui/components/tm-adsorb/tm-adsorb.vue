<template>
	<!-- #ifdef MP -->
	<view :data-prop="towxsShareData" @touchstart="touch.startDrag" @touchmove.stop="touch.onDrag" @touchend="touch.endDrag">
	<!-- #endif -->
	<!-- #ifdef H5||APP-VUE -->
	<view :data-prop="towxsShareData" @touchstart="touch.startDrag" @touchmove="touch.onDrag" @touchend="touch.endDrag">
	<!-- #endif -->
	<!-- #ifdef APP-NVUE -->
	<view  >
	<!-- #endif -->
		<view id="adsorb" ref="adsorb"  :style="{ left: _offset[0] + 'rpx', top: _offset[1] + 'rpx' }" class="div" @touchstart="touchstart">
			<view
