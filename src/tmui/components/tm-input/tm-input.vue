<template>
  <tm-sheet :event-penetration-enabled="true" :transprent="true" :margin="props.margin" :padding="props.padding">
    <tm-sheet
    ...
    >
      ...
      >
        <view v-if="propsDetail.search || propsDetail.searchLabel" class="px-4px"></view>
        <slot name="left"></slot>
        <view v-if="propsDetail.prefix" class="pr-8px">
          <tm-icon
        ...
        <view v-if="propsDetail.prefixLabel" class="pr-12px">
          <tm-text
            _style="transition:color 0.24s"
            :font-size="propsDetail.fontSize"
            :color="props.prefixColor"
        ...
        <view v-if="propsDetail.showClear && _valueLenChar > 0" class="pl-16" @click="clearBtn">
          <tm-icon
            :customicon="props.customicon"
            _style="transition:color 0.24s"
        ...
        <view v-if="showPasswordIcon" class="pl-16" @click="changeSeePassword">
        ...
        <slot name="right">
          <view v-if="propsDetail.search || propsDetail.searchLabel" class="pl-16">
            <TmButton
              ...
              :margin="[0, 0]"
              :font-color="props.searchFontColor"
