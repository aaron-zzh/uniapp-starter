  ...
  <s-layout title="我的订单">
    ...
    <view v-if="state.pagination.total > 0">
      ...
      >
        ...
        <view v-for="item in order.items" :key="item.id" class="border-bottom">
          <s-goods-item
            :img="item.picUrl"
            :title="item.spuName"
...
import { fen2yuan, formatOrderColor, formatOrderStatus, handleOrderButtons } from '@/hooks/useGoods'
