...
<template>
  <s-layout title="物流追踪">
    <view class="log-wrap">
      <!-- 商品信息 -->
      <view v-if="goodsImages.length > 0" class="log-card ss-flex ss-m-20 ss-r-10">
      ...
      <view class="log-content ss-m-20 ss-r-10">
        <view v-for="(item, index) in state.tracks" :key="item.title" class="log-content-box ss-flex">
