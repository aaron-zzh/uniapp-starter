  ...
  <s-layout class="wallet-wrap" title="钱包">
    ...
    <su-sticky>
      ...
      <view class="filter-box ss-p-x-30 ss-flex ss-col-center ss-row-between">
        <uni-datetime-picker v-model="state.data" type="daterange" :end="state.today" @change="onChangeTime">
    ...
    <view v-if="state.pagination.total > 0">
      <view v-for="item in state.pagination.list" :key="item.id" class="wallet-list ss-flex border-bottom">
